        ...
        <footer class="yan-footer">
            <div class="yan-footer-wrap">
                <div class="yan-footer-grid">
                    <section>
                        <a href="index.html"><img class="yan-footer-logo" src="images/logo2.webp" alt="YAN Travels" /></a>
                ...
                <div class="yan-footer-bottom">&copy; ${year} YAN Travels Sri Lanka. All rights reserved.</div>
            </div>
        </footer>

        <a class="yan-float" href="https://wa.me/94703577490?text=Hi YAN Travels, I would like to ask about bookings." aria-label="WhatsApp">
